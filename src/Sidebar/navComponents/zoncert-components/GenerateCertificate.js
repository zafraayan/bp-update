...
function GenerateCertificate() {
  const [code, setCode] = useState("tz");
      ...
      <Document>
        <Page size="Folio" style={zoncertstyles.page}>
          ...
          <View style={zoncertstyles.row}>
            ...
            <View style={zoncertstyles.cell}>
              <Text style={zoncertstyles.cellHeading}>Area (in hectares)</Text>
            </View>
            <View style={zoncertstyles.cell}>
          ...
          <Text style={zoncertstyles.paragraph}>
            ...
            2021-05 otherwise known as the Comprehensive Land Use of the City of
            Talisay, Cebu and approved by the Sangguniang Panlalawigan on April
            04, 2023 throught the resolution no. 140-2003 in accordance with
            pertinent issuances as amended by City Zoning Ordinance No. 64
            (s.2021).
          </Text>
            ...
            (el) =>
              el.code === code && (
                <>
                  ...
                  <Text style={zoncertstyles.paragraph}>{el.descriptions}</Text>
                  ...
                  <View style={zoncertstyles.conditionItem}>
                    ...
                    <Text style={zoncertstyles.conditions}>
                      ...
                      of the applicant shall be suficient cause for the
