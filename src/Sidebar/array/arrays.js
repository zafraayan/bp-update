...
`,
  ...
  },
  {
    ...
    uses: [
      ...
      {
        id: 4,
        item: "Pastoral activities such as goat and cattle raising",
        subItem: [],
      },
      {
        id: 5,
      ...
      {
        id: 6,
        item: "Backyard raising of livestock and fowl, provided that:",
        subItem: [
          {
            id: 1,
            item: "Maximum of 1 sow and 10 heads for livestock",
          },
          {
            id: 2,
            item: "Maximum of 500 heads for fowl",
          },
        ],
      },
      {
      ...
      {
        id: 9,
        item: "Ancillary dwelling units/farmhouses for tenants, tillers, and laborers",
        subItem: [],
      },
      {
        id: 10,
        item: "Engaging in home businesses such as dressmaking, tailoring, baking, running a sari- sari store, and the like provided that:",
        subItem: [
          {
            id: 1,
            item: "The number of persons engaged in such business/industry shall not exceed five, inclusive of owner",
